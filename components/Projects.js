...
import { defProjectCapsule } from '../modules/initialization';

function Projects(props) { 
// const essai2 = "blabladfsfdfdssssssssssssssssssssssssssssssssssssssssssss ssssssssssssssssssssssssssss sssssssssssssssssssssssss ssssssssssssssssssssgdgddddddddddddddddddddddd ddddddddddddddddddddddddddddddddd ddddddddddddddddddddderrrrrrrr"
...
//                     {title : "essai2", message:essai2 , skillsFront :["HTML", "CSS","JS"], skillsBack : [], image : "TicketHack.png"},
//                     {title : "essai3", message:"blabla", skillsFront :["React", "CSS","JS"], skillsBack:["PHP"], image : "TicketHack.png"}
//                     ];

const theProjects = defProjectCapsule ();
